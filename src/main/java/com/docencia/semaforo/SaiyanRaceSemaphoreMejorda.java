...
public class SaiyanRaceSemaphoreMejorda implements Runnable {
    ...
    public SaiyanRaceSemaphoreMejorda(String name) {
        this.name = name;
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        Thread goku = new Thread(new SaiyanRaceSemaphoreMejorda("Goku"));
        Thread vegeta = new Thread(new SaiyanRaceSemaphoreMejorda("Vegeta"));
